      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4 flex-wrap">
            ...
            <button
              className="w-40 h-40 bg-gray-100 rounded-xl shadow flex items-center justify-center cursor-pointer hover:bg-gray-200"
            >
          ...
          <div className="bg-white p-6 rounded-2xl shadow flex-1 space-y-4">
            <h3 className="text-lg font-semibold mb-3">Camera</h3>
              <div className="flex gap-5 flex-wrap">
                <CameraCard name="Living Room" camera="Camera 1" image={livingRoom} className="w-52 flex-1" />
                <CameraCard name="Kitchen" camera="Camera 2" image={kitchen} className="w-52 flex-1" />
                <CameraCard name="Master BedRoom" camera="Camera 3" image={bedroom} className="w-52 flex-1" />
              </div>
          </div>
